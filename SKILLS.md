...
*Generated at: 2026-09-17 02:01:35 UTC*
...
| `ask-adam` | 1.4.0 | workflow, router | Catalog menu first, else Wrap ask-matt. |
...
| `zyxel-automation` | 1.0.0 | workflow, redmine, gitlab | Automation: Sibling-exec GitLab, Outline, Teams, Grafana, to-be-pulled. |
...
| `zyxel-rm-analyze` | 1.0.1 | redmine, workflow, frontend | RM: Scratch issue from one Redmine issue, then Implement gate. Use when the user says 讀 RM or RM-#####. |
